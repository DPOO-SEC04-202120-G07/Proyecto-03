...
public class LogInInventario extends JDialog{
	...
	public LogInInventario(JFrame owner) {
	super(owner, true);
	...
	setTitle("Log-In: Sistema Inventario");
	...
	//Label Titulo
	JLabel labelTitulo = new JLabel("Log-In: Sistema Inventario");
	...
	//Label ID
	JLabel labelID = new JLabel("ID Encargado");
