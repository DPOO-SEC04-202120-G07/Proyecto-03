...
public class InterfazSI {
		...
		while (true) {
			...
			try {
				...
				if (e.getCode() == "null-supermercado") {
					...
					System.out
							.println("El código del producto ingresado no se encuentra registrado en el supermercado.");
					...
					System.out.println(
							"La unidad en la que se desea almacenar el producto no existe, intentelo de nuevo.");
				}
			}
	...
	public void ejecutarOpcion(int opcion) throws HandledException {
		...
		case 2:
			...
			break;
		case 3:
			String idProducto = input(
					"Ingrese el codigo que identifica al producto que desea consultar (recuerde el prefijo P- si no se trata de un codigo de barras): ");
	...
	public String askUnidad(String nombre) {
		String idUnidad = "U-"
				+ input("Ingrese el ID de la unidad en la que desea almacenar el producto '" + nombre + "': U-");
		return idUnidad;
	}
